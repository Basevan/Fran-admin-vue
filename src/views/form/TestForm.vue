...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleConfirm(){
                if (this.hasChange()){
                    if ("编辑" === this.title) {
                        ...
                        if (this.dialogData.level === 3){
                            this.oneLine.domain = this.dialogData.domain;
                        }
                        this.oneLine.uri = this.dialogData.uri;
                        this.oneLine.name = this.dialogData.name;
                        this.oneLine.icon = this.dialogData.icon;
                        // this.oneLine.sort = this.dialogData.sort;
                        ...
                        this.oneLine.uri = this.dialogData.uri;
                        this.oneLine.name = this.dialogData.name;
                        this.oneLine.icon = this.dialogData.icon === undefined ? 'el-icon-menu' : this.dialogData.sort;
            ...
            //变为树形列表
            changeToTree(list){
                this.treeData.push({id: 0,name: '根目录'});
