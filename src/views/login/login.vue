          ...
          <el-form :model="ruleForm" status-icon label-width="0" class="demo-ruleForm" >
            ...
            <el-row>
              <el-col :offset="2" :span="20">
                <el-input type="text" suffix-icon="el-icon-user-solid" v-model="ruleForm.account" placeholder="手机号/用户名/邮箱"></el-input>
              </el-col>
            </el-row>
            <el-row>
              <el-col :offset="2" :span="20">
                <el-input type="password" suffix-icon="el-icon-lock" show-password v-model="ruleForm.password" placeholder="请输入密码"></el-input>
              </el-col>
            </el-row>
            <el-row>
...
<!--                <canvas id="code-canvas" width="100px" height="36px" style="border: 1px solid #ccc;border-radius: 5px;" @click="createCanvas"></canvas>-->
            ...
            <el-row>
              <el-col :offset="2" :span="20">
                <el-button class="sign-in-btn" size="medium" type="primary" data-loading="正在验证，请稍后..." @click="submitForm">登录</el-button>
              </el-col>
            </el-row>
            <el-row>
              <el-col :offset="5">
